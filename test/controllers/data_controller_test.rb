...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post data_url, params: { datum: { description: @datum.description, menu_id: @datum.menu_id } }, as: :json
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { description: @datum.description, menu_id: @datum.menu_id } }, as: :json
    assert_response 200
  end
