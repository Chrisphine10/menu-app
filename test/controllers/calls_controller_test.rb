...
class CallsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create call" do
    assert_difference('Call.count') do
      post calls_url, params: { call: { description: @call.description, menu_id: @call.menu_id } }, as: :json
    end
  ...
  test "should update call" do
    patch call_url(@call), params: { call: { description: @call.description, menu_id: @call.menu_id } }, as: :json
    assert_response 200
  end
